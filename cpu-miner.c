...
static void show_credits()
{
	...
	printf("BTC donation address: 1NW7fhN7Vi9YM6g4DLCz4CiPsbjnC7yFob\n");
	printf("XMR donation address: 42tvWQxSLZFVQGegMbBfiZhHbhXXbnTu4bp2ispbA1ErN78hDQFQ2o5HF8CKhpJQxXb9nXYoJvtiafDwLna5WE483hD6dKx\n\n");
}
